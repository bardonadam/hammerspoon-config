-- SOURCE: https://gist.github.com/JavierSA/afcfa5ccaceabcb6ab84
...
hs.hotkey.bind(MASH, "p", function() toggleSpotify() end)
...
-- hs.hotkey.bind(MASH, "Up", function() operateFrame(moveToTopKeepingVisibility, 0.1) end)
-- hs.hotkey.bind(MASH, "Down", function() operateFrame(moveToBottomKeepingVisibility, 0.1) end)
-- hs.hotkey.bind(MASH, "Left", function() operateFrame(moveToLeftKeepingVisibility, 0.1) end)
-- hs.hotkey.bind(MASH, "Right", function() operateFrame(moveToRightKeepingVisibility, 0.1) end)
-- hs.hotkey.bind(MASH_SHIFT, "Up", function() operateFrame(adjustToTopHalf) end)
-- hs.hotkey.bind(MASH_SHIFT, "Down", function() operateFrame(adjustToBottomHalf) end)
-- hs.hotkey.bind(MASH_SHIFT, "Left", function() operateFrame(adjustToLeftHalf) end)
-- hs.hotkey.bind(MASH_SHIFT, "Right", function() operateFrame(adjustToRightHalf) end)

hs.hotkey.bind(MASH, "c", function() operateFrame(moveToMainCenter) end)
hs.hotkey.bind(MASH, "s", function() operateFrame(moveSpotify) end)
hs.hotkey.bind(MASH, "r", function() operateFrame(moveToRight) end)
...
function moveToMainCenter()
    -- hs.alert.show()
    focusedWindowFrame.x = screenFrame.w / 2 - 1000
    focusedWindowFrame.y = 750
    focusedWindowFrame.w = 2000
    focusedWindowFrame.h = 1360
end

function moveSpotify()
    focusedWindowFrame.x = screenFrame.w / 2 - 700
    focusedWindowFrame.y = 23
    focusedWindowFrame.w = 1400
    focusedWindowFrame.h = 726
end

function moveToRight()
    focusedWindowFrame.x = screenFrame.w / 2 + 1000
    focusedWindowFrame.y = 750
    focusedWindowFrame.w = 920
    focusedWindowFrame.h = 1360
end
